...
public class VideoRenderer implements GLTextureView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private VideoRenderer.OnSurfacePrepareListener onSurfacePrepareListener;
    ...
    void setOnSurfacePrepareListener(VideoRenderer.OnSurfacePrepareListener onSurfacePrepareListener) {
