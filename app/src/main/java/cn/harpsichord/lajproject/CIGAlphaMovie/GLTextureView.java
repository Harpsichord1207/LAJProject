package cn.harpsichord.lajproject.CIGAlphaMovie;
...
public class GLTextureView
     ...
     * {@link GLTextureView.GLWrapper#wrap(javax.microedition.khronos.opengles.GL)} method is called
    ...
    public void setRenderer(Renderer renderer) {
        ...
        if (mEGLConfigChooser == null) {
            mEGLConfigChooser = new GLTextureView.SimpleEGLConfigChooser(true);
        }
        if (mEGLContextFactory == null) {
            mEGLContextFactory = new GLTextureView.DefaultContextFactory();
        }
        if (mEGLWindowSurfaceFactory == null) {
            mEGLWindowSurfaceFactory = new GLTextureView.DefaultWindowSurfaceFactory();
        }
        mRenderer = renderer;
        mGLThread = new GLTextureView.GLThread(mThisWeakRef);
        mGLThread.start();
    }
    ...
    public void setEGLConfigChooser(boolean needDepth) {
        setEGLConfigChooser(new GLTextureView.SimpleEGLConfigChooser(needDepth));
    }
    ...
    public void setEGLConfigChooser(int redSize, int greenSize, int blueSize,
        ...
        setEGLConfigChooser(new GLTextureView.ComponentSizeChooser(redSize, greenSize,
    ...
    static class GLThread extends Thread {
        ...
        private void guardedRun() throws InterruptedException {
            mEglHelper = new GLTextureView.EglHelper(mGLSurfaceViewWeakRef);
            mHaveEglContext = false;
            mHaveEglSurface = false;
            try {
                GL10 gl = null;
...
//                }
    ...
    private static final GLTextureView.GLThreadManager sGLThreadManager = new GLTextureView.GLThreadManager();
